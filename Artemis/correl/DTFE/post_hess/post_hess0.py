...
f1=h5py.File("/scratch/GAMNSCM2/bolchoi_z0/correl/DTFE/files/output_files/hessian_comp/fil__DTFE_gd%d_smth%sMpc_ifft_dxx.h5" %(grid_nodes,round(std_dev_phys,3)), 'r')
f2=h5py.File("/scratch/GAMNSCM2/bolchoi_z0/correl/DTFE/files/output_files/hessian_comp/fil__DTFE_gd%d_smth%sMpc_ifft_dxy.h5" %(grid_nodes,round(std_dev_phys,3)), 'r')
f3=h5py.File("/scratch/GAMNSCM2/bolchoi_z0/correl/DTFE/files/output_files/hessian_comp/fil__DTFE_gd%d_smth%sMpc_ifft_dyy.h5" %(grid_nodes,round(std_dev_phys,3)), 'r')
f4=h5py.File("/scratch/GAMNSCM2/bolchoi_z0/correl/DTFE/files/output_files/hessian_comp/fil__DTFE_gd%d_smth%sMpc_ifft_dzz.h5" %(grid_nodes,round(std_dev_phys,3)), 'r')
f5=h5py.File("/scratch/GAMNSCM2/bolchoi_z0/correl/DTFE/files/output_files/hessian_comp/fil__DTFE_gd%d_smth%sMpc_ifft_dzx.h5" %(grid_nodes,round(std_dev_phys,3)), 'r')
f6=h5py.File("/scratch/GAMNSCM2/bolchoi_z0/correl/DTFE/files/output_files/hessian_comp/fil__DTFE_gd%d_smth%sMpc_ifft_dzy.h5" %(grid_nodes,round(std_dev_phys,3)), 'r')
...
f=h5py.File("/scratch/GAMNSCM2/bolchoi_z0/correl/DTFE/files/output_files/eigvecs/fil_recon_vecs_DTFE_gd%d_smth%sMpc_%d.h5" %(grid_nodes,round(std_dev_phys,3),part), 'w')
