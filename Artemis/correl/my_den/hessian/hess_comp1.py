...
f=h5py.File("/project/GAMNSCM2/snapshot_012_LSS_class/correl/DTFE/files/output_files/hessian_comp/fil__DTFE_gd%d_smth%skpc_ifft_dxx.h5" %(grid_nodes,std_dev_phys), 'w')
f.close()
'''
...
f=h5py.File("/scratch/GAMNSCM2/bolchoi_z0/correl/my_den/files/output_files/hessian_comp/fil__DTFE_gd%d_smth%sMpc_ifft_dxx.h5" %(grid_nodes,round(std_dev_phys,3)), 'w')
